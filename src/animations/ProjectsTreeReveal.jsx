...
export default function ProjectsTreeReveal() {
  ...
  return (
    <div
      ref={containerRef}
      className="projects-tree-overlay"
    >
      {/* ANIMATED CENTER BEAM */}
      <div
        ref={beamRef}
        className="projects-tree-animated-beam"
      />

      {/* TOP LEFT */}
      <div
        ref={branch1Ref}
        className="projects-animated-branch left top"
      />

      {/* TOP RIGHT */}
      <div
        ref={branch2Ref}
        className="projects-animated-branch right top"
      />

      {/* BOTTOM LEFT */}
      <div
        ref={branch3Ref}
        className="projects-animated-branch left bottom"
      />

      {/* BOTTOM RIGHT */}
      <div
        ref={branch4Ref}
        className="projects-animated-branch right bottom"
      />
    </div>
  );
}